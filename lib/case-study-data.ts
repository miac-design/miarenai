...
export const caseStudies: CaseStudy[] = [
    {
        ...
        approach: [
            "Conducted a full EXACT Audit across ChatGPT, Perplexity, Gemini, and Copilot — testing 25+ category-relevant queries",
            ...
            "Created a content architecture designed for citation — each page answered specific queries AI engines receive",
        ],
        results: [
        ...
        keyInsight:
            "Even companies that build AI can be invisible to AI. Technical expertise doesn't automatically translate to AI discoverability. Structured data, entity consistency, and content architecture are entirely separate disciplines — and they're what determine whether AI recommends you or your competitor.",
    },
    {
        slug: "austin-ai-hub",
        ...
        approach: [
            "Full EXACT Audit revealing a baseline AI Visibility Score of 4% across all platforms",
        ...
        keyInsight:
            "Nonprofits and community organizations are particularly vulnerable to AI invisibility because they rarely invest in technical SEO, let alone GEO. Yet these are often the exact organizations people are searching for with AI — 'best AI communities near me,' 'where to learn AI in Austin,' 'volunteer opportunities in tech.' The gap between mission impact and digital discoverability is where GEO creates the most meaningful change.",
    },
    {
        slug: "enterprise-tech-audit",
        client: "Large Enterprise Technology Provider",
        industry: "Enterprise Cloud & Infrastructure",
        type: "EXACT Audit (Diagnostic Only)",
