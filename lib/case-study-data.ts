...
export const caseStudies: CaseStudy[] = [
    {
        ...
        keyInsight:
            "Even companies that build AI can be invisible to AI. Technical expertise doesn't automatically translate to AI discoverability. Structured data, entity consistency, and content architecture are entirely separate disciplines. They're what determine whether AI recommends you or your competitor.",
    },
    {
        slug: "austin-ai-hub",
        ...
        keyInsight:
            "Nonprofits and community organizations are particularly vulnerable to AI invisibility because they rarely invest in technical SEO, let alone GEO. Yet these are often the exact organizations people are searching for with AI. Queries like 'best AI communities near me,' 'where to learn AI in Austin,' 'volunteer opportunities in tech.' The gap between mission impact and digital discoverability is where GEO creates the most meaningful change.",
    },
    {
