    ...
    <>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="glass-card p-8 md:p-10">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-full bg-teal/20 flex items-center justify-center text-teal text-xl font-bold">
                MC
              </div>
              <div>
                ...
                <h2 className="text-2xl font-bold text-navy">
                  Mia (Mahboubeh) Cheraghian
                </h2>
                <p className="text-sm text-warm-gray">
                  Researcher · AI Strategist · Founder, Miaren AI
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mt-6">
              {[
                ...
                "Dir. of Partnerships & Marketing, Austin AI Hub",
                "Peer Reviewer",
                "30+ Brand Audits",
              ].map((tag) => (
                <span
      ...
      <section className="py-20 md:py-28 bg-soft-white bg-node-network">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-warm-gray leading-relaxed max-w-3xl mb-14">
            ...
            {[
              {
                ...
                description:
                  "Using smart glasses and AI to make travel accessible for people with travel hesitation, including people with disabilities. Research focused on removing barriers to experience through technology.",
              },
              {
                chapter: "Chapter 2",
                title: "Austin AI Hub",
                ...
                description:
                  "Bringing AI education and accessibility to underserved communities in Austin. Building bridges between emerging technology and the people most often left out of the conversation.",
              },
              {
                chapter: "Chapter 3",
                title: "Miaren AI",
                focus: "Businesses left behind",
                description:
                  "Making GEO and AI visibility accessible to small businesses and underrepresented voices who can't compete with big tech. Because when AI decides who gets recommended, the stakes aren't just commercial.",
              },
            ].map((ch) => (
              <div key={ch.chapter} className="glass-card p-8">
                ...
                <p className="text-xs font-mono text-teal mb-4">
                  Focus: {ch.focus}
                </p>
          ...
          <p className="mt-10 text-warm-gray italic text-center">
            The thread that ties it together: making technology work for
            everyone, not just those with resources.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description:
                  "Every recommendation is backed by data. We measure before we advise.",
              },
              {
                title: "Radical Clarity",
                description:
                  "No jargon, no buzzwords. If we can't explain it simply, we don't understand it well enough.",
              },
              {
                title: "Future-Facing",
                description:
                  "Preparing for where the AI landscape is heading, not just where it is today.",
              },
              {
                title: "Builder's Mentality",
                description:
                  "We create frameworks and capability. We build independence, not dependency.",
              },
              {
                title: "Visible Integrity",
                description:
                  "We practice what we preach. Our own brand is optimized for AI visibility.",
              },
            ].map((value) => (
        ...
        <div className="max-w-xl mx-auto px-6">
          <div className="bg-teal-light border border-teal/20 rounded-2xl p-10 text-center">
            ...
            <p className="mt-3 text-warm-gray">
              Let&apos;s discuss how GEO can transform your brand&apos;s AI visibility.
            </p>
            <div className="mt-8">
