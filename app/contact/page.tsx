...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get a free AI visibility audit from Miaren AI. Tell us about your brand and we'll show you exactly where you stand in AI search — and what to do about it.",
};
  ...
  return (
    <>
      ...
      <section className="bg-navy py-16 md:py-20 bg-node-network-dark">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-warm-gray text-lg">
            Tell me about your brand. I&apos;ll show you exactly where you stand
          ...
          <div className="grid md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-3">
              <div className="glass-card p-8">
                <div className="inline-flex items-center gap-2 border border-teal/30 rounded-full px-4 py-1.5 mb-6">
                ...
                <p className="text-sm text-warm-gray mb-8">
                  No pitch. No pressure. Just an honest look at where your
                  brand stands in AI search.
                </p>
                <ContactForm />
              </div>
            </div>
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-navy rounded-xl p-6">
                <div className="flex items-start gap-3 mb-4">
                  <div className="w-12 h-12 rounded-full bg-teal/20 flex items-center justify-center text-teal text-sm font-bold shrink-0">
                    MC
                  </div>
                  <p className="text-sm text-gray-300 italic leading-relaxed">
                    &ldquo;I&apos;ve audited brands across every industry. Most score
                    below 20% on AI visibility — and they had no idea.
      ...
      <section className="py-16 bg-soft-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="text-teal text-3xl mb-4">&ldquo;&rdquo;</div>
          <p className="text-lg md:text-xl text-navy leading-relaxed">
            Most companies I audit score below 20% on AI visibility. Their
            competitors are being cited every time. The gap is fixable — but
